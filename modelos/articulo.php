<?php
    class Articulo {
        ...
        public static function listarArticuloGrid(){
            $listaArticulo=[];
            $conexion = BD::crearInstancia();
            $sql = $conexion->query("SELECT a.idArticulo,a.articulo,a.precio,a.descuento,b.categoria,c.marca,d.url FROM articulo a INNER JOIN categoria b ON b.idCategoria = a.idCategoria INNER JOIN marca c ON c.idMarca = a.idMarca INNER JOIN imagen_articulo d ON d.idArticulo = a.idArticulo and d.portada = 1 WHERE a.estado = 1 and b.estado = 1 and c.estado = 1");
